                    ...
                    <div class="card-body">
                        <div class="invoice-header">
                            ...
                            <div class="billed-from">
                                <h6>EslamSoft, Badawy.</h6>
                                <p>201 Something St., Something Town, YT 242, Country 6546<br>
                                    Tel No: 01150099801<br>
                                    Email: eslambadawy25688@BadawySoft.com</p>
                            </div><!-- billed-from -->
                        </div><!-- invoice-header -->
                            ...
                            <div class="col-md">
                                ...
                                <div class="billed-to">
                                    ...
                                    <p>4033 Patterson Road, Staten Island, NY 10301<br>
                                        Tel No: 01117556204<br>
                                        Email: eslambadawy3030@Badawy.com</p>
                                </div>
                            </div>
                            <div class="col-md">
                                ...
                                <p class="invoice-info-row"><span>تاريخ الاصدار</span>
                                    <span>{{ $invoices->invoice_data }}</span></p>
