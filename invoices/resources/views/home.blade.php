				...
				<div class="breadcrumb-header justify-content-between">
					<div class="left-content">
						<div>
						  ...
						  <p class="mg-b-0">في اسلام سوفت للفواتير</p>
						</div>
					</div>
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7">{{ round(( \App\Models\Invoice::where('value_status' , 2)->count() / \App\Models\Invoice::count() )*100 , 2)}}%</span>
										</span>
									</div>
								</div>
							</div>
							...
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">
												{{ \App\Models\Invoice::where('status' , 'مدفوعة')->sum('total') }}
											</h4>
							...
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">
												{{ \App\Models\Invoice::where('status' , 'مدفوعة جزئيا')->sum('total') }}
											</h4>
