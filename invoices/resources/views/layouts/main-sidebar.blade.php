<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			<div class="main-sidebar-header active">
				...
				<a class="desktop-logo logo-light active" href="{{ url('/' . $page='index') }}"><h1>EslamSoft</h1></a>
					...
					@endcan
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								...
								<li><a class="slide-item" href="{{ route('Search_customers_index') }}">تقارير العملاء</a></li>
							</ul>
						</li>
