							...
							<div class="dropdown nav-item main-header-notification">
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left">
												<a href="{{route('MarkAsRead_all')}}">تعين قراءة الكل</a></span>
										</div>
										<p id="notifi_count" class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">عدد الاشعارات الغير مقرؤة {{ auth()->user()->unreadNotifications->count() }}</p>
									</div>
									<div id="unreadNotifications">
										...
										@else
											<div class="mr-3">
												<h5 class="notification-label m-3">لا توجد اشعارات غير مقرؤة</h5>
											</div>
										@endif
									</div>
								</div>
